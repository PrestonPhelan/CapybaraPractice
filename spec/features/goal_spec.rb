...
feature "viewing own goals" do
  ...
  FactoryGirl.create(:goal, goal_name: "Secret goal", private: true, user_id: 1)
...
feature "viewing other user's goals" do
  ...
  FactoryGirl.create(:goal, goal_name: "Secret goal", private: true, user_id: 2)
...
feature "updating goals" do
  ...
  feature "update goal page" do
    ...
    scenatio "after update, redirects to user's homepage" do
      click_on "Update"
